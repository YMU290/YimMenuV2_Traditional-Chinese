	...
	void ProcessOnboarding()
	{
		...
		if (ImGui::BeginPopupModal("IMPORTANT! PLEASE READ!", nullptr, ImGuiWindowFlags_NoSavedSettings))
		{
			...
			ImGui::TextWrapped("%s",
			    ...
			    "https://github.com/TommyLam120/YimMenuV2_Traditional-Chinese. Make sure to only download the menu from GitHub to avoid malware. "
			...
			{
				ShellExecuteA(NULL, "open", "https://github.com/TommyLam120/YimMenuV2_Traditional-Chinese", NULL, NULL, SW_SHOWNORMAL);
			}
			ImGui::SameLine();

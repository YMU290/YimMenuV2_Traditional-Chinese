...
namespace YimMenu::Submenus
{
	    ...
	    Submenu::Submenu(TR("Self"), ICON_FA_USER)
	{
		...
		auto visionGroup = std::make_shared<Group>(TR("Vision & HUD"));
		...
		toolsGroup->AddItem(std::make_shared<CommandItem>("claimownbounty"_J,TR("Claim Own Bounty")));
		toolsGroup->AddItem(std::make_shared<BoolCommandItem>("autoheal"_J,TR("Auto Heal")));
		toolsGroup->AddItem(std::make_shared<BoolCommandItem>("autoarmor"_J,TR("Auto Armor")));
		...
		movementGroup->AddItem(std::make_shared<BoolCommandItem>("beastjump"_J,TR("Beast Jump")));
		...
		movementGroup->AddItem(std::make_shared<BoolCommandItem>("superman"_J,TR("Superman")));
		...
		visionGroup->AddItem(std::make_shared<BoolCommandItem>("nightvision"_J,TR("Night Vision")));
		visionGroup->AddItem(std::make_shared<BoolCommandItem>("thermalvision"_J,TR("Thermal Vision")));
		visionGroup->AddItem(std::make_shared<BoolCommandItem>("hideradar"_J,TR("Hide Radar")));
		visionGroup->AddItem(std::make_shared<BoolCommandItem>("hidehud"_J,TR("Hide HUD")));

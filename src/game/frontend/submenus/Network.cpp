...
namespace YimMenu::Submenus
{
	    ...
	    Submenu::Submenu(TR("Network"), ICON_FA_ROUTE)
	{
		...
		customPlayerTp->AddItem(std::make_shared<Vector3CommandItem>("playertpcoord"_J, TR("Player Teleport Coords","")));
		...
		enhancements->AddItem(std::make_shared<BoolCommandItem>("admincheck"_J,TR("Admin Check")));

...
namespace YimMenu::Features
{
	static FloatCommand m_Radius{
	    "forcefieldradius",
	    TR("Forcefield Radius"),
	    TR("Radius around the target player where vehicles/peds are pushed away."),
	    0.0f,
	    1000.0f,
	    10.0f};
	...
	static FloatCommand m_Magnitude{
	    "forcefieldmagnitude",
	    TR("Forcefield Magnitude"),
	    TR("Strength of the push away from the target player."),
	    0.0f,
	    1000.0f,
	    10.0f};
	...
	static Forcefield _Forcefield{
	    "forcefield",
	    TR("Forcefield"),
	    TR("Pushes vehicles and peds away from the selected player")};
}

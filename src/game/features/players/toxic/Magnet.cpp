...
namespace YimMenu::Features
{
	static FloatCommand m_Radius{
	    "magnetradius",
	    TR("Magnet Radius"),
	    TR("Radius around the target player where vehicles/peds are affected."),
	    0.0f,
	    1000.0f,
	    10.0f};
	...
	static FloatCommand m_Magnitude{
	    "magnetmagnitude",
	    TR("Magnet Magnitude"),
	    TR("Strength of the magnetic pull toward the target player."),
	    0.0f,
	    1000.0f,
	    10.0f};
	...
	static Magnet _Magnet{
	    "magnet",
	    TR("Magnet"),
	    TR("Pulls vehicles and peds toward the selected player")};
}

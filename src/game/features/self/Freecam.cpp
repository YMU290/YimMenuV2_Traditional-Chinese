...
{
	static FloatCommand _FreecamSpeed{"freecamspeed", TR("Freecam Speed"), TR("How fast the freecam will move positions"), 0.01f, 10.0f, 0.10f};
	...
	static Freecam _Freecam{"freecam", TR("Freecam"), TR("Detaches your camera and allows you to go anywhere!")};
}
...
namespace YimMenu::Features
{
	...
	static FloatCommand _NoclipSpeed{"noclipspeed", TR("Noclip Speed"), TR("Features"), 0.1f, 2.0f, 0.14f};
	...
	static Noclip _NoClip{"noclip", TR("No Clip"), TR("Allows you to fly through the map")};
}
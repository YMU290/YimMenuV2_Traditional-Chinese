...
namespace YimMenu::Features
{
	...
	static ListCommand _SelectedSpecialAbility{"selspecialability", TR("Special Ability in MP"), TR("The special ability to enable for the MP character"), g_SpecialAbilityTypes, 0};
	...
	static MpSpecialAbility _MpSpecialAbility{"mpspecialability", TR("Enable Special Abilities in MP"), TR("Enables special abilities in multiplayer. This repurposes cut content and may be unstable")};

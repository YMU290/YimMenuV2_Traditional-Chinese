...
namespace YimMenu::Features
{
	...
	static FloatCommand _ExplosionDamageScale{
	    ...
	    TR("Sets the damage scale for explosions"),
	    0.0f,
	    1000.0f,
	    1.0f};
	...
	static FloatCommand _CameraShake{
	    ...
	    TR("Controls how much the camera shakes during explosions"),
	    0.0f,
	    10.0f,
	    0.1f};
	...
	static ExplosiveAmmo _ExplosiveAmmo{"ExplosiveAmmo", TR("Explosive Ammo"), TR("Every bullet you shoot explodes.")};
}

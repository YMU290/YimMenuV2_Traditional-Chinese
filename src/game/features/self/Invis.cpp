...
{
	static BoolCommand _LocallyVisible{"localvis", TR("Locally Visible"), TR("Be locally visible while remaining invisible to other players")};
	...
	static Invis _Invis{"invis", TR("Invisibility"), TR("Be invisible")};
}
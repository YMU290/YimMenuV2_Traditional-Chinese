...
{
	static FloatCommand _WeaponDamageScale{"weapondamagescale", TR("Weapon Damage Scale"), TR("Sets the damage scale for weapons (including melee)"), 0.0f, 10.0f, 1.0f};
	...
	static WeaponDamage _WeaponDamage{"weapondamage", TR("Weapon Damage"), TR("Allows altering your weapons damage output")};
}
...
{
		static IntCommand RPSlider{"rpslider",TR("RP Slider"), TR("Character level selection"), 1, 8000, 1};
		...
		static ApplyRP _ApplyRP{"applyrp", TR("Set Character Level"), TR("Sets your wanted level to the desired level set in the slider.")};
}

...
namespace YimMenu::Features
{
	class Speedometer : public LoopedCommand
	{
		...
		virtual void OnTick() override
		{
			...
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(MISC::SHOULD_USE_METRIC_MEASUREMENTS() ? TR("KPH") : TR("MPH"));
	...
	static Speedometer _Speedometer{"speedometer", TR("Speedometer"), TR("Shows a speedometer whenever you are in a vehicle")};
}
...
{
	static BoolCommand _AutoUpdateEnabled{"playerdbautoupdate", TR("Player Database Auto Update"), TR("Automatically updates tracked player status every 3 minutes. This is required for tracking notifications to work"), true};
	static BoolCommand _PlayerTracking{"playerdbnotify", TR("Tracking Notifications"), TR("Notifies you when the state of a player you track changes"), true};
	static BoolCommand _NotifyWhenJoinable{"playerdbnotifywhenjoinable", TR("Notify When Joinable"), TR("Notifies you when a tracked player becomes joinable"), true};
	static BoolCommand _NotifyWhenUnjoinable{"playerdbnotifywhenunjoinable", TR("Notify When Unjoinable"), TR("Notifies you when a tracked player becomes unjoinable"), true};
	static BoolCommand _NotifyWhenOnline{"playerdbnotifywhenonline", TR("Notify When Online"), TR("Notifies you when a tracked player goes online"), true};
	static BoolCommand _NotifyWhenOffline{"playerdbnotifywhenoffline", TR("Notify When Offline"), TR("Notifies you when a tracked player goes offline"), true};
	static BoolCommand _NotifyOnSessionTypeChange{"playerdbnotifyonseschange", TR("Notify On Session Type Change"), TR("Notifies you when a tracked player's session type changes")};
	static BoolCommand _NotifyOnMissionChange{"playerdbnotifyonmischange", TR("Notify On Mission Change"), TR("Notifies you when a tracked player joins or leaves a mission")};
	static BoolCommand _NotifyOnTransitionChange{"playerdbnotifyonjoblobby", TR("Notify On Job Lobby Change"), TR("Notifies you when a tracked player joins or leaves a job lobby")};
	...
	UpdateSavedPlayersNow _UpdateSavedPlayersNow{"playerdbupdatenow", TR("Update Saved Players Now"), TR("Force-updates all saved players")};
}
